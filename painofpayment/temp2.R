...
write_csv(corr_summary, "corr_summary_temp.csv")
...
ordinal_formula <- as.formula(paste("painful_1 ~ ", paste(grep("^f_", names(person_level_long), value = TRUE), collapse = " + ")))
...
write_csv(ordinal_stats, "painofpayment/ordinal_model_stats_temp.csv")