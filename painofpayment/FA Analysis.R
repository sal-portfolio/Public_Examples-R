...
ind_vars <- c(colnames(fa_prod1$scores), "like_1", "ln_disutility")
...
write.csv(FA_onProd1_output, "painofpayment/output/final_like_disutility_numonly.csv", row.names = FALSE, na = "")
