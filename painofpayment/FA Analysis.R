...
ind_vars <- c(colnames(fa_prod1$scores), "like_1", "purchased", "ln_disutility", "ln_typ_charge")
...
write.csv(FA_onProd1_output, "painofpayment/output/1.like_allcontrols.csv", row.names = FALSE, na = "")
